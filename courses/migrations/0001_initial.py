...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('course_from', 'course_to'), name='unique_relation_reverse'),
        ),
        migrations.AddConstraint(
            model_name='courserelation',
            constraint=models.CheckConstraint(check=models.Q(('course_from', models.F('course_to')), _negated=True), name='prevent_self_relation'),
        ),
    ]
