    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cover_image', models.ImageField(blank=True, null=True, upload_to='images/references/', validators=[core.validators.MaxImageSizeValidator(1)], verbose_name='Cover Image')),
